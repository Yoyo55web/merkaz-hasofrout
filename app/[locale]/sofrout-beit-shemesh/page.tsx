...
const CITY_FR = "Beit Shemesh";
const CITY_HE = "בית שמש";
const SLUG = "sofrout-beit-shemesh";
      ...
      <section className="mx-auto max-w-6xl px-5 py-12">
        <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="mt-4 space-y-3 text-sm text-slate-700">
              ...
              <div className="rounded-xl border bg-slate-50 p-4">
                <div className="text-sm font-semibold text-slate-900">
                  {isHebrew ? "למי זה מתאים?" : "Pour qui ?"}
                </div>
                <p className="mt-2 text-sm text-slate-700">
                  {isHebrew
                    ? "למי שרוצה מענה ברור, תיאום מסודר ודיסקרטיות — בלי בלבול."
                    : "Pour ceux qui veulent une réponse claire, une coordination ordonnée et de la discrétion — sans confusion."}
                </p>
              </div>
            </div>
          ...
          <div id="faq" className="rounded-2xl border bg-slate-50 p-6">
            <h3 className="text-lg font-semibold">{isHebrew ? "שאלות נפוצות" : "FAQ"}</h3>
            ...
            <div className="mt-4 space-y-4 text-sm text-slate-700">
              ...
              <div>
                <div className="font-semibold">
                  {isHebrew ? "אני לא יודע מה לבחור…" : "Je ne sais pas quoi choisir…"}
                </div>
                <p className="mt-1 text-slate-600">
                  {isHebrew
